...
# Title: Top Block
# Generated: Fri Oct 30 23:06:04 2015
##################################################
...
class top_block(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        self.rtlsdr_source_0.set_bb_gain(bbgain, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_reject_filter_0.set_taps(firdes.band_reject(1, self.samp_rate/4, 1419.5e6, 1421.5e6, 100e3, firdes.WIN_HAMMING, 6.76))
    ...
    def set_bbgain(self, bbgain):
        ...
        self.rtlsdr_source_0.set_bb_gain(self.bbgain, 0)
